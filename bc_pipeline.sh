...
echo "Total Number of Isoforms: ${NUMBER_OF_ISOFORMS}" >> STATS.log
echo "Isoforms Not Found: ${ISOFORMS_NOT_FOUND}" >> STATS.log
...
echo "Number of Isoforms Exclusively Reported in Trinity: ${ISOFORMS_TRINITY}" >> STATS.log
...
echo "Number of Unique Isoforms Exclusively Reported in Trinity: ${ISOFORMS_TRINITY_UNIQ}" >> STATS.log
echo "Number of Shared Unique Isoforms: $((total_isoform_found_uniq - ISOFORMS_TRINITY_UNIQ -2 ))" >> STATS.log
